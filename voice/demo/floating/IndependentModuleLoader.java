...
public class IndependentModuleLoader implements IModuleLoader{
	...
	public IconBean getIcon() {
		InputStream resourceAsStream = getClass().getResourceAsStream("/images/maincore/VOICE demo：floating.svg");
		...
		if (resourceAsStream == null) {
			...
			System.err.println("Warning: Icon resource not found: /images/maincore/VOICE demo：floating.svg");
			return iconBean;
		}

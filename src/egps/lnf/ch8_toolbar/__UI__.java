...
public class __UI__ {
	...
	public static void uiImpl() {
		...
		// ~* JToolBar.putClientProperty("ToolBar.isPaintPlainBackground",
		// Boolean.TRUE);来进行
		...
		ColorUIResource toolbarShadow = new ColorUIResource(new Color(180, 183, 187));
		UIManager.put("ToolBar.shadow", toolbarShadow);
		// 此属性目前用于ToolBar.border中表示触点的立体阴影效果颜色
		ColorUIResource toolbarHighlight = new ColorUIResource(Color.white);
		UIManager.put("ToolBar.highlight", toolbarHighlight);
...
//				com.sun.java.swing.plaf.windows.WindowsBorders.getToolBarBorder()));
				new BEToolBarUI.ToolBarBorder(toolbarShadow, toolbarHighlight,
						new Insets(6, 0, 11, 0))));

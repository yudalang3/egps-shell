...
public class ReflectHelper {
	 ...
	 */
	public static Object invokeStaticMethod(String theClassFullName, String methodName, Class[] paramsType,
			Object[] paramsValue) {
	 ...
	 * @return 如果该方法有返回值且正常调用则返回该值，否则返回null
	 */
	public static Object invokeStaticMethod(Class theClass, String methodName, Class[] paramsType,
			Object[] paramsValue) {
	 ...
	 * @return 如果该方法有返回值且正常调用则返回该值，否则返回null
	 */
	public static Object invokeMethod(String theClassFullName, Object theObject, String methodName, Class[] paramsType,
			Object[] paramsValue) {
	 ...
	 * @return 如果该方法有返回值且正常调用则返回该值，否则返回null
	 */
	public static Object invokeMethod(Class theClass, Object theObject, String methodName, Class[] paramsType,
			Object[] paramsValue) {
		Object ret = null;
		if (theClass != null) {
			try {
...
//										   +"("+Arrays.toString(paramsType)+")成功.");
				...
				LogHelper.error("通过反射调用方法" + theClass.getName() + "." + methodName + "(" + Arrays.toString(paramsType)
						+ ")失败，您的JRE版本可能需要更新，" + e.getMessage());
			}
		}
		return ret;
	}

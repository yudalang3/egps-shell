 ...
 * <p>
 * 本类中的各方法都是自动根据JVM版本不同对SwingUtilities2进行反射调用
 * 实现的，以便解决兼容性问题。.
 *
...
//       }
   ...
   {
	   //java1.6及以后更新版本位于sun.swing包内，目前截至JDK1.7.0_u6是在这个包内，
	   // 之前在 "com.sun.java.swing.SwingUtilities2"
	   // 我看JAVA 1.8.191变成了 "com.sun.java.swing.SwingUtilities3"
		   String[] candidates = {

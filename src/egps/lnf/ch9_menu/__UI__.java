...
//		UIManager.put("PopupMenu.border",new BorderUIResource(BorderFactory.createEmptyBorder(20,10,20,10)));//	
		...
		UIManager.put("CheckBoxMenuItem.checkIcon",new BECheckBoxMenuItemUI.CheckBoxMenuItemIcon());//javax.swing.plaf.basic.BasicIconFactory.CheckBoxMenuItemIcon);

 ...
 */
package egps.lnf.widget.border;
 ...
 * @see egps.lnf.BeautyEyeLNFHelper.FrameBorderStyle#translucencySmallShadow
 */
public class BEShadowBorder extends NinePatchBorder//AbstractBorder
{
	...
	public BEShadowBorder()
	{
		super(new Insets(TOP, LEFT, BOTTOM, RIGHT)
				, egps.lnf.widget.__Icon9Factory__.getInstance().getBorderIcon_Shadow1());
	}

...
import egps.lnf.utils.MySwingUtilities2;
...
//		FontMetrics fm = SwingUtilities2.getFontMetrics(b, g);
		...
		if (fm == null) {
			java.awt.Font font = (g != null && g.getFont() != null) ? g.getFont() : b.getFont();
			if (b != null && font != null) {
				fm = b.getFontMetrics(font);
			}
			if (fm == null && g != null) {
				fm = g.getFontMetrics(font != null ? font : g.getFont());
			}
		}

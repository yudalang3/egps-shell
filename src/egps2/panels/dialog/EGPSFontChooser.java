...
/**
 * EGPSFontChooser is a reusable Swing panel or dialog within eGPS.
 */
public class EGPSFontChooser extends JComponent {
	// class variables
	/**
	...
	/**
	 * 为什么这里都是偶数呢？因为如果是中文的话，两个字符编码一个汉字
	 */
	 ...
	 **/
	public EGPSFontChooser() {
		this(DEFAULT_FONT_SIZE_STRINGS, DEFAULT_SELECTED_FONT);
	}
	public EGPSFontChooser(Font currentFont) {
		this(DEFAULT_FONT_SIZE_STRINGS, currentFont);
	}
	
	public EGPSFontChooser(String[] fontSizeStrings) {
		this(fontSizeStrings, DEFAULT_SELECTED_FONT);
	}
	 ...
	 **/
	public EGPSFontChooser(String[] fontSizeStrings, Font currentFont) {
		...
		this.setSelectedFont(currentFont);
	...
	public JList<String> getFontStyleList() {
		if (fontStyleList == null) {
			...
			fontStyleList.addListSelectionListener(new ListSelectionHandler(fontStyleList, getFontStyleTextField()));
	...
	public JList<String> getFontSizeList() {
		if (fontSizeList == null) {
			...
			fontSizeList.addListSelectionListener(new ListSelectionHandler(fontSizeList, getFontSizeTextField()));
	...
	/**
	 * ListSelectionHandler is a reusable Swing panel or dialog within eGPS.
	 */
	...
	/**
	 * TextFieldFocusHandlerForTextSelection is a reusable Swing panel or dialog within eGPS.
	 */
	...
	/**
	 * TextFieldKeyHandlerForListSelectionUpDown is a reusable Swing panel or dialog within eGPS.
	 */
	...
	/**
	 * ListSearchTextFieldDocumentHandler is a reusable Swing panel or dialog within eGPS.
	 */
	protected class ListSearchTextFieldDocumentHandler implements DocumentListener {
		...
		/**
		 * ListSelector is a reusable Swing panel or dialog within eGPS.
		 */
	...
	/**
	 * DialogOKAction is a reusable Swing panel or dialog within eGPS.
	 */
	...
	/**
	 * DialogCancelAction is a reusable Swing panel or dialog within eGPS.
	 */

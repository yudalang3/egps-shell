...
import egps2.utils.GraphicsUtils;
...
/**
 * Label provides shared utility logic for eGPS modules and UI.
 */
public class Label extends JLabel {
    ...
    public Label(String text, Icon icon, int horizontalAlignment) {
        ...
        setBorder(null);
        setFont(new Font("SimHei", Font.PLAIN, 13));
...
//			 e.printStackTrace();
    ...
    public void setBorder() {
        ...
        setForeground(Color.decode("#F8E890"));

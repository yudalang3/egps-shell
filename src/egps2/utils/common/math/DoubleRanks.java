 ...
 * @since 2.0
 */
public class DoubleRanks implements RankingAlgorithm {
	 ...
	 */
	public DoubleRanks(TiesStrategy tiesStrategy) {
		super();
	 ...
	 */
	public DoubleRanks(NaNStrategy nanStrategy) {
		super();
	 ...
	 *            TiesStrategy to use
	 */
	public DoubleRanks(NaNStrategy nanStrategy, TiesStrategy tiesStrategy) {
		super();
		this.nanStrategy = nanStrategy;
		this.tiesStrategy = tiesStrategy;
		randomData = new RandomDataGenerator();
	 ...
	 */
	public DoubleRanks(RandomGenerator randomGenerator) {
		super();
	 ...
	 *            source of random data
	 */
	public DoubleRanks(NaNStrategy nanStrategy, RandomGenerator randomGenerator) {
		super();
		this.nanStrategy = nanStrategy;
		this.tiesStrategy = TiesStrategy.RANDOM;
		randomData = new RandomDataGenerator(randomGenerator);
